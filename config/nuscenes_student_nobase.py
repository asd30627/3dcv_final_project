...
data_aug_conf = {
    ...
    "H": 480,
    "W": 640,
    "rand_flip": False,              # 影像 flip 由 dataset 決定
}
...
train_pipeline = [
    ...
    dict(
        type="LoadTeacherDumpNPZ",
        bev_prob_dir="/mnt/xs1000/teacher_dump/bev_prob",
        occ3d_dir="/mnt/xs1000/teacher_dump/occ3d_logits",
        split_key="phase",
        id_key="dump_idx",
        suffix_bev="_bev_prob_fp16.npz",
        suffix_occ="_3d_logits_fp16.npz",
        strict=True,
    ),
